...
public class Reader implements OnHighlightListener, ReadLocatorListener, FolioReader.OnClosedListener {
    ...
    private String loadAssetTextAsString() {
        ...
        try {
            ...
            Log.e("EPUB LOAD ASSET ERROR", "Flutter Error opening asset " + "highlights/highlights_data.json");
            Log.e("propererror", e.getMessage());
            ...
            if (in != null) {
                try {
                    ...
                    Log.e("EPUB LOAD ASSET ERROR", "Flutter Error closing asset " + "highlights/highlights_data.json");
                }
            }
        }
        return "";
